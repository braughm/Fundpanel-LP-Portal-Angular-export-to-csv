...
export class ExportToCsv {
    ...
    /**
     * 
     * @param replaceSpace replaces all the spaces present in the data with underscore if true.
     */
    generateCsv(jsonData: any, shouldReturnCsv: boolean = false, replaceSpace: boolean = false): void | any {
